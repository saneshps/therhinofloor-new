...
<link rel="canonical" href="<?php echo e(route('news.index')); ?>" />
...
<div class="page-title-area pt-220 pb-240 pt-lg-120 pb-lg-125 pb-md-100" data-background="<?php echo e(asset('assets/img/news/news-banner.jpg')); ?>">

	<link rel="preload" as="image" href="<?php echo e(asset('assets/img/news/news-banner.jpg')); ?>" fetchpriority="high">
...
<section class="products-section pt-100 pb-165 pt-lg-120 pb-lg-105">
	...
	<div class="container">
		...
		<!--				<a href="<?php echo e($new->link); ?>" target="_blank"><img data-src="<?php echo e(env('APP_ADMIN_URL')); ?><?php echo e($new->image); ?>" class="figure-img w-100 lozad" alt="news"></a>-->
		...
		<!--			    <?php echo Str::limit($new->description, 100) . '...'; ?>		-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/hcoyym1o/therhinofloor.com/resources/views/news/index.blade.php ENDPATH**/ ?>