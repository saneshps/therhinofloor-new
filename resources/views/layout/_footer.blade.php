	<footer class="footer-area" style="overflow: hidden !important;">
			<div class="footer-bg-two pt-95">
				<img class="shapes__1" src="{{asset('assets/img/shape/star-3a.svg')}}" alt="">
				<img class="shapes__2" src="{{asset('assets/img/shape/line-7a.svg')}}" alt="">
				<div class="blur__shape"></div>
				<div class="container pt-10 pt-lg-10">
					<div class="row mb-25">
						<div class="col-xxl-3 col-lg-4 col-md-6">
							<div class="footer__widget mb-30 px-xxl-3">
								<a href="{{route('home')}}"><img src="{{asset('assets/img/logo/header-logo-1.png')}}" alt="Logo"></a>
						...
						<div class="col-xxl-3 col-lg-4 col-md-6">
							<div class="footer__widget mb-30">
								...
								<ul class="fot-list">
									...
									<li>
										<a href="{{route('products.detail',$product->slug)}}"> {{$product->display_title!="" ? $product->display_title : $product->name }}</a>
									</li>
									@endforeach
							...
							<div class="footer__widget mb-30">
								...
								<div class="footer__contact">
									...
									<p class="mb-25">
										...
										TEL : <a href="tel:+966554222379"> +966 55 422 2379 </a> <br>
						...
						<div class="row align-items-center">
							<div class="col-lg-6 text-center text-lg-start">
								<div class="copyright__text mb-30">
									<p>
										...
										© {{date('Y')}} <a class="fw-bold" href="https://www.therhinofloor.com/" target="_blank">www.therhinofloor.com </a>
							...
							<div class="col-lg-6 text-center text-lg-end">
								<ul class="footer__menu mb-30">
									<li>
										<a href="{{route('our-story')}}"> About Us </a>
									</li>
									<li>
