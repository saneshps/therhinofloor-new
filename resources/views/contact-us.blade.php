...
@section('content')
  ...
  <div class="page-title-area pt-220 pb-240 pt-lg-120 pb-lg-125 pb-md-100" data-background="{{asset('assets/img/contact/contact-banner.jpg')}}">
      <link rel="preload" as="image"  href="{{asset('assets/img/contact/contact-banner.jpg')}}"  fetchpriority="high">
          ...
          <div class="row contact__info__wrapper me-xxl-4 pe-xxl-5 mb-45">
              ...
              <div class="single__info__box">
                <div class="icon">
                  ...
                  <span>
                    ...
                    Building No: 7446 - King Abdulaziz Rd<br>
                    Madinat Al Ummal Dist.<br>
                    Al Khobar 34441<br>
                    Kingdom of Saudi Arabia<br>
                    Short Address: EKJC7446
                  </span>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6">
              <div class="single__info__box">
                ...
                <span> <a href="tel:+966554222379"> +966 55 422 2379 </a></span>
              </div>
            </div>
        ...
        <div class="col-xl-6 col-lg-12">
          <div class="contact-form-one">
            ...
            @if(Session::get('message'))
                        <div class="alert alert-success alert-block" id="cp">
                            <button type="button" class="close" data-dismiss="alert" style="float: right;border: none;">×</button>
                            <h6><strong>{{ Session::get('message') }}</strong></h6>
                        </div>
                        @endif
            <form class="widget-form" action="{{route('contact-mail')}}" method="post">
                 @csrf
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <button class="btn5 ht_btn hover-bg border-0" data-id="0">Send Message</button>
                </div>
              </div>
            </form>
          </div>
