                  ...
                  <table class="table"
                    ...
                    <tbody>
                      <tr style="width:100% !important; border-spacing: 0;">
                        <td>
                          <img class="logo" src="{{asset('assets/img/mail/mg-logo.png')}}" alt="Logo"
                            style="max-width:130;">
                        </td>
                        <td style="text-align:right;padding: 10px 10px 10px 0;font-size:14px;">
                          <a href="mailto:sales@rhinofloor.ae"
                            ...
                            <img src="{{asset('assets/img/mail/mail.png')}}" alt="mail"
                              style="padding: 0 2px 0 0; width: 25px; margin-bottom: -8px;" alt="mail">
                            sales@rhinofloor.ae </a>
                          <p style="margin:0 0 5px; ">
                            <img src="{{asset('assets/img/mail/phoe.png')}}" alt="phone"
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  ...
                                  <p>You recieved an Express Interest from website:</p>
                  ...
                  <table style="width: 100%; border-spacing: 0;">
                   <tr>
                      <td style="width: 100%;   padding: 15px; text-align: center; background: #252525; color: #fff;">
                       ...
                       "> <img src="{{asset('assets/img/mail/facebook.png')}}" style="width: 25px;" alt=""> </a>
                        <a href="https://www.instagram.com/rhino.floor/?igshid=k4kzc88x9zrl" target="b
                      "> <img src="{{asset('assets/img/mail/instagram.png')}}" style="width: 25px;" alt=""> </a>
                        <a href="https://www.linkedin.com/company/rhino-floor/?originalSubdomain=ae" target="
                      "> <img src="{{asset('assets/img/mail/linked.png')}}" style="width: 25px;" alt=""> </a>
                      </td>
                    </tr>
                  </table>
                  <!--// connect with us end -->
                  ...
                  <table style="width: 100%; border-spacing: 0;">
                    <tr>
                      <td style="width:100%; text-align: center;">
                        <img src="{{asset('assets/img/mail/mg-fooetr-logo.png')}}" alt="logo"
