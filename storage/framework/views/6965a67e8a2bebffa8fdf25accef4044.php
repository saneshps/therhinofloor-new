				...
				<div class="container header-custom-container">
					<div class="row align-items-center">
						<div class="col-lg-2 col-sm-4 col-6 d-none d-lg-inline-block">
							<div class="logo-area">
								<a class="front" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt="rhinofloor"></a>
							</div>
						</div>
						<div class="col-lg-10 col-md-12 custom-border px-lg-0">
									...
									<ul class="ps-lg-5 list-none header-info d-flex align-items-center justify-content-xl-start justify-content-lg-end justify-content-center">
										...
										<li class="phn-call">
											<div class="header-info-box">
												<div class="icon">
													<img src="<?php echo e(asset('assets/img/icon/phone.svg')); ?>" alt="Phone">
												</div>
												<div class="text-content">
													<span>Call</span>
													<!--<h6> <a href="tel:+97165264382"> +971 652 643 82 </a> </h6>-->
												</div>
											</div>
										</li>
										...
										<li class="loctn">
											<div class="header-info-box">
												<div class="icon">
													<img src="<?php echo e(asset('assets/img/icon/location.svg')); ?>" alt="Phone">
												</div>
												<div class="text-content">
										...
										<li class="mail-id">
											<div class="header-info-box">
												<div class="icon">
													<img src="<?php echo e(asset('assets/img/icon/email.png')); ?>" alt="email">
												</div>
												<div class="text-content">
													<span> Email </span>
							...
							<div class="row align-items-center">
									...
									<div class="main-menu d-none d-lg-block ps-xl-5 ps-lg-3">
										<nav id="mobile-menu">
											<ul class="menu-list ps-0">
												...
												<li> <a href="<?php echo e(route('our-story')); ?>"> Our Story </a> </li>
												<li> <a href="#"> Products <i class="fas fa-angle-down"></i> </a>
													<ul class="sub-menu">
        													<?php
        													$i = 0;
        													?>
        													<?php $__currentLoopData = $total_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                              
        													<li>  
        													 <?php if(count($category->products) > 0 || $sub_categories_count[$i] != 0): ?>
        															<a href="<?php echo e(route('products.category', $category->short_code)); ?>"><?php echo e($category->name); ?> <span class="sub-menu-arrow"><i class="bi bi-chevron-right"></i></span></a>
        															<ul class="sub-menu">
        																<?php if(count($category->products) > 0): ?>
        																<?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        																<li> <a href="<?php echo e(route('products.detail', $product->slug)); ?>"> <?php echo e($product->name); ?> </a> </li>
        																...
        																<li> <a href="<?php echo e(route('products.category',['slug'=>$sub_category->short_code])); ?>"> <?php echo e($sub_category->name); ?> </a> </li>
        																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        																<?php endif; ?>
        													...
        													<?php else: ?>
        													<a href="<?php echo e(route('products.category', $category->short_code)); ?>"> <?php echo e($category->name); ?> </a>
        													<?php endif; ?>
											...
											<li> <a href="<?php echo e(route('applications.index')); ?>"> Applications <i class="fas fa-angle-down"></i> </a>
												<ul class="sub-menu">
													...
													<li> <a href="<?php echo e(route('applications.detail', $app->slug)); ?>"> <?php echo e($app->title); ?></a> </li>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											 ...
											 <li> <a href="<?php echo e(route('works')); ?>"> Gallery </a> </li> 
								...
								<div class="col-6 d-lg-none d-md-inline-block">
									<div class="logo-area">
										<a class="front" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('assets/img/logo/header-logo-1.png')); ?>" alt="Header-logo"></a>
									</div>
								</div>
									...
									<div class="right-nav mb-0 d-flex align-items-center justify-content-end ms-5">
										<!-- <div class="search-area me-4">
											<a class="search_input" href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
												<img src="<?php echo e(asset('assets/img/icon/search.svg')); ?>" alt="Search">
											</a>
										</div> -->
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-187454492-2"></script>
  <script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-187454492-2');
</script>
<!-- Global site tag (gtag.js) - Google Analytics -->
...
})(window,document,'script','dataLayer','GTM-MFVR8S2');</script>
<!-- End Google Tag Manager -->



		</header><?php /**PATH /home4/hcoyym1o/therhinofloor.com/resources/views/layout/_header.blade.php ENDPATH**/ ?>