...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(asset('assets/fonts/bootstrap-icons/font-css.css')); ?>" />
	...
	<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-CDZCTLQBH1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-CDZCTLQBH1');
</script>
...
<body>
	<div class="main-page-wrapper" style="overflow: hidden !important;">
			...
			<div class="offset-sidebar">
				<div class="offset-widget offset-logo mb-30">
					<a href="<?php echo e(route('home')); ?>">
						<img src="<?php echo e(asset('assets/img/logo/header-logo-1.png')); ?>" alt="logo">
					</a>
				</div>
		...
		<!--<?php echo $__env->make('layout._map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>-->
       </main>
...
</html><?php /**PATH /home4/hcoyym1o/therhinofloor.com/resources/views/layout/app.blade.php ENDPATH**/ ?>