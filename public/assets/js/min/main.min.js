!(function (e) {
  ...
  e(window).on("load", function () {
    ...
    e("#mobile-menu-active .has-dropdown > a").on("click", function (e) {
      e.preventDefault();
    }),
    e(".hamburger-menu > a").on("click", function (i) {
      i.preventDefault(),
        e(".slide-bar").toggleClass("show"),
        e("body").addClass("on-side"),
        e(".body-overlay").addClass("active"),
        e(this).addClass("active");
    }),
    e(".close-mobile-menu > a").on("click", function (i) {
      i.preventDefault(),
        e(".slide-bar").removeClass("show"),
        e("body").removeClass("on-side"),
        e(".body-overlay").removeClass("active"),
        e(".hamburger-menu > a").removeClass("active");
    }),
    ...
    e(window).on("scroll", function () {
      ...
      200 > i
        ? e(".main-header-area").removeClass("sticky-menu")
        : e(".main-header-area").addClass("sticky-menu");
    });
  var i = window.location.href.substr(
    window.location.href.lastIndexOf("/") + 1
  );
  e(".menu-list > li  a").each(function () {
    (e(this).attr("href") == i || "" == e(this).attr("href")) &&
      e(this).addClass("active");
  }),
    e(".shopping-cart").on("click", function () {
      e(".cart-menu-right").addClass("cart-info");
    }),
    e(".close-icon").click(function () {
      e(".cart-menu-right").removeClass("cart-info");
    });
  {
    const a =
        ...
        new Swiper(".services__slide__one", {
          direction: "horizontal",
          slidesPerView: 1,
          loop: !0,
          autoplay: { delay: 2500, disableOnInteraction: !1 },
        ...
        new Swiper(".testimonial__slider__one", {
          direction: "horizontal",
          slidesPerView: 1,
          loop: !0,
          autoplay: { delay: 2500, disableOnInteraction: !1 },
        ...
        new Swiper(".hero__thumbs__slider", {
          direction: "horizontal",
          slidesPerView: 3,
          loop: !0,
          autoplay: { delay: 2500, disableOnInteraction: !1 },
      ...
      n =
        ...
        new Swiper(".services__slider__two", {
          direction: "horizontal",
          slidesPerView: 2,
          loop: !0,
          autoplay: { delay: 2500, disableOnInteraction: !1 },
        ...
        new Swiper(".case__slider__two", {
          ...
          pagination: { el: ".swiper-pagination", clickable: !0 },
          breakpoints: {
            320: { slidesPerView: 1, spaceBetween: 20, centeredSlides: !1 },
            768: { slidesPerView: 2, spaceBetween: 30, centeredSlides: !1 },
            991: { slidesPerView: 3, spaceBetween: 30 },
          },
        }),
        new Swiper(".testimonial__slider__two", {
          direction: "horizontal",
          slidesPerView: 3.5,
          loop: !0,
          centeredSlides: !1,
        ...
        new Swiper(".hero__slider__three", {
          direction: "horizontal",
          slidesPerView: 1,
          loop: !0,
          autoplay: { delay: 2500, disableOnInteraction: !1 },
        ...
        new Swiper(".testimonial__slider__three", {
          direction: "horizontal",
          slidesPerView: 1,
          loop: !0,
          autoplay: { delay: 2500, disableOnInteraction: !1 },
        ...
        new Swiper(".product__thumbs__slider", {
          direction: "horizontal",
          slidesPerView: 4,
          spaceBetween: 10,
          loop: !0,
  ...
  e(".price-btn").click(function () {
    var i = e(".price-btn").text().trim();
    "Monthly" == i
      ? (e(".price-btn").text("Yearly"),
        e(".yearly-price").show(),
        e(".monthly-price").hide())
      : (e(".price-btn").text("Monthly"),
        e(".monthly-price").show(),
        e(".yearly-price").hide());
  }),
    e(function () {
    ...
    e(".qtybutton").on("click", function () {
      ...
      if ("+" == i.text()) var n = parseFloat(a) + 1;
      else if (a > 0) var n = parseFloat(a) - 1;
      else n = 0;
      i.parent().find("input").val(n);
    }),
    e(function () {
