...
<link rel="canonical" href="{{ route('our-story') }}" />
...
<div class="page-title-area pt-220 pb-240 pt-lg-120 pb-lg-125 pb-md-100" data-background="{{asset('assets/img/application/application-banner.jpg')}}">

  <link rel="preload" as="image" href="{{asset('assets/img/application/application-banner.jpg')}}" fetchpriority="high">
...
<section class="about__area">
  ...
  <div class="grey-bg about__section__wrapper pt-120 pb-70 pt-lg-120 pb-lg-30">
    ...
    <img class="about__shape__2" src="{{asset('assets/img/shape/about-line-3a.svg')}}" alt="About Shape"> -->
 ...
 and OMAN, our activities
        ...
        <div class="col-lg-3 d-flex justify-content-center justify-content-lg-end">
          ...
          <div class="about__circular__box mb-30">
            ...
            <img class="circular-image" src="{{asset('assets/img/about/circular-text.png')}}" alt="Circular Text">

            <span> <img src="{{asset('assets/img/about/circular-image.png')}}" alt="Circular Text" class="cir_text"> </span>
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <div class="single__box premium-box mb-30">
          ...
          <div class="icon mb-35">
            ...
            <img class="back-icon" src="{{asset('assets/img/about/Long-Lasting.png')}}" alt="Icon">
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <div class="single__box premium-box mb-30">
          ...
          <div class="icon mb-35">
            ...
            <img class="back-icon" src="{{asset('assets/img/about/Easy-to-clean.png')}}" alt="Icon">
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <div class="single__box premium-box mb-30">
          ...
          <div class="icon mb-35">
            ...
            <img class="back-icon" src="{{asset('assets/img/about/heavy-duty.png')}}" alt="Icon">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              ...
              <div class="brand__img">
                ...
                <a href="#"><img src="{{asset('assets/img/brand/1.png')}}" alt="Brand Logo"></a>
            ...
            <div class="swiper-slide">
              ...
              <div class="brand__img">
                ...
                <a href="#"><img src="{{asset('assets/img/brand/2.png')}}" alt="Brand Logo"></a>
            ...
            <div class="swiper-slide">
              ...
              <div class="brand__img">
                ...
                <a href="#"><img src="{{asset('assets/img/brand/3.png')}}" alt="Brand Logo"></a>
            ...
            <div class="swiper-slide">
              ...
              <div class="brand__img">
                ...
                <a href="#"><img src="{{asset('assets/img/brand/4.png')}}" alt="Brand Logo"></a>
