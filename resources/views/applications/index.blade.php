...
<link rel="canonical" href="{{ route('applications.index') }}" />
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          ...
          <div class="single__services__box mb-60">
            ...
            <div class="services__thumb">
              ...
              <img class="w-100 lozad" data-src="{{env('APP_ADMIN_URL')}}{{$application->image}}" alt="{{$application->image_alt}}">
            ...
            <div class="services__content">
              ...
              <!-- <div class="services__icon">
                ...
                <img src="{{asset('assets/img/application/application-icon.png')}}" alt="Icon">

              </div> -->

              <h4 class="single__service__title"><a href="{{route('applications.detail', $application->slug)}}">

                  {{$application->title}} </a>

              </h4>

              <a href="{{route('applications.detail', $application->slug)}}"><img src="{{asset('assets/img/icon/long-arrow.svg')}}" alt="Arrow"></a>
