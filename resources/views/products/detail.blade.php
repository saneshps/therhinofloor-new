...
<meta name="keywords" content="{{$product->product_meta->keywords}}">

<meta name="description" content="{{$product->product_meta->meta_details}}">

<title> {{$product->product_meta->meta_title}} </title>
...
<meta property="og:title" content="{{$product->product_meta->meta_title}}">

<meta name='og:image' content='images/assets/ogg.png'>

<link rel="canonical" href="{{ route('products.detail', $product->slug) }}" />
...
<div class="page-title-area pt-220 pb-240 pt-lg-120 pb-lg-125 pb-md-100" data-background="{{isset($product_banner)?env('APP_ADMIN_URL').$product_banner->image_url:''}}" style="background-image: url(&quot;{{isset($product_banner)?env('APP_ADMIN_URL').$product_banner->image_url:''}}&quot;);">

  <link rel="preload" as="image" href="{{isset($product_banner)?env('APP_ADMIN_URL').$product_banner->image_url:''}}" fetchpriority="high">
...
<section class="product-details-section pt-180 pt-lg-90 pb-50">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs-page">
      ...
      <nav aria-label="breadcrumb">
        ...
        <ul class="breadcrumb list-none justify-content-center justify-content-md-start">
          ...
          <li><a href="{{route('products.category',$product->category->short_code)}}">{{$product->category->name}}</a></li>
    ...
    <div class="row align-items-start">
      ...
      @if($product->default_image!=""||$product_gallery->count()>0)
          ...
          <div class="swiper-wrapper mb-20">
            ...
            <div class="swiper-slide product-item">
              ...
              <a data-fancybox="gallery" href="{{env('APP_ADMIN_URL').$product->default_image}}">
                ...
                <img class="w-100 lozad" data-src="{{env('APP_ADMIN_URL').$product->default_image}}" alt="Fortelock">
            ...
            <div class="swiper-slide product-item">
              ...
              <a data-fancybox="gallery" href="{{env('APP_ADMIN_URL').$gallery->image_url}}">

                <img class="w-100 lozad" data-src="{{env('APP_ADMIN_URL').$gallery->image_url}}" alt="Fortelock">
        ...
        <div class="swiper product__thumbs__slider">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product__thumb">
              ...
              <img class="lozad" data-src="{{env('APP_ADMIN_URL').$product->default_image}}" alt="Big Image">
            ...
            <div class="swiper-slide product__thumb">
              ...
              <img class="lozad" data-src="{{env('APP_ADMIN_URL').$gallery->image_url}}" alt="Big Image">
        ...
        <div class="product-details-content pt-lg-4 ps-xl-5">
          ...
          <div class="product-details">
            ...
            <div class="product-description-head" id="short_desc">
              ...
              {!! \Illuminate\Support\Str::limit($product->description, 650, $end='...') !!}<br>
            ...
            <div class="suppliers-know-more">
              ...
              <img data-src="{{env('APP_ADMIN_URL')}}{{$product->product_brand->logo_url}}" class="lozad" alt="suppliers">

              <a href="{{$product->product_brand->website}}" class="ht_btn"><span> Know More <img src="assets/img/icon/arrow1.svg" alt=""></span></a>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 product-manager">
        ...
        <h3> {{$product->product_manager->designation}}</h3>

        <img data-src="{{env('APP_ADMIN_URL').$product->product_manager->image_url}}" alt="{{$product->product_manager->designation}}" class="img-fluid lozad">

        <h4> {{$product->product_manager->name}} </h4>
        ...
        <div class="row align-items-center justify-content-start">
          ...
          <div class="col-lg-12">
            ...
            <ul class="grey-bg nav nav-tabs product-tab" id="myTab" role="tablist">
              ...
              @if(count($product->product_catalogues) > 0)
              ...
              @if(count($product->product_videos) > 0)

              <li class="nav-item" role="presentation">

                <button class="nav-link {{ count($product->product_catalogues) > 0 ? '' : 'active'}}" id="profile-tab2" data-bs-toggle="tab" data-bs-target="#profile2" type="button" role="tab" aria-controls="profile2" aria-selected="false"> Videos
          ...
          <div class="col-lg-12">
            ...
            <div class="tab-content mt-40 mb-45" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6 catalogues">
                    ...
                    <iframe src="{{env('APP_ADMIN_URL').$catalogue->catalogue}}" height="250"></iframe>

                    <br>



                    <a href="{{env('APP_ADMIN_URL').$catalogue->catalogue}}" class="ht_btn catalogue-download-btn"><span> Download
              ...
              <div class="tab-pane fade {{ count($product->product_catalogues) > 0 ? '' : 'show active'}}" id="profile2" role="tabpanel" aria-labelledby="profile-tab2">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 service-single-video mb-40">
                    ...
                    <img class="w-100 img-fluid" src="http://img.youtube.com/vi/{{$youtube_id}}/hqdefault.jpg" alt="img">
